    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if(postId != null && visitedPageId != null) {
                ...
                logger.log(Level.INFO, accountName + " sent a unlike in the social network.");
            }
            else {
                logger.log(Level.WARNING, authUser.getAccountName() + " did not provide a pageId or visitedPageId.");
                request.setAttribute("errorMessage", "No a pageId or or visitedPageId. was provided.");
